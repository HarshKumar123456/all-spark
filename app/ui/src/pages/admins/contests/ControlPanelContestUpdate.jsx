...
const ControlPanelContestUpdate = () => {
    ...
    const handleClickOnUpdateContestButton = async () => {
        ...
        try {
            ...
            const response = await axios.put(`${API_BASE}/contests/control/update`, payload, {
                headers: {
                    "Content-Type": "application/json",
                    "client-id": clientId,
                    "authorization": token,
    ...
    // If the WebSocket Connection Changes then Please Fetch Contest's Details, All the Support Users, Private Problems Again
    useEffect(() => {
    ...
    // Listener 2: Handle Valid Update Contest's Response
    useSocketListener(
        // Selector: "Is this message for me?"
        (msg) => msg.type?.includes('response') && msg.metadata.operation?.includes("contests.control.update"),
    ...
    // Listener 3: Handle Valid Get Support Role User's List Response
    useSocketListener(
        // Selector: "Is this message for me?"
    ...
    // Listener 4: Handle Valid Get All Private Problems' List Response
    useSocketListener(
        // Selector: "Is this message for me?"
                        ...
                        <div className="mb-16 text-nowrap flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <MultiSelectCheckBoxInput
                                    ...
                                    value={contestDetails.support_team} // Array of values in this input Array of Id of Support Team User 
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <MultiSelectCheckBoxInput
                                    ...
                                    value={contestDetails.problems} // Array of values in this input Array of Id of Problems 
                                    onValueChange={(newValue) => {
                                        setContestDetails((prev) => {
                                            return {
                                                ...prev,
...
export default ControlPanelContestUpdate;