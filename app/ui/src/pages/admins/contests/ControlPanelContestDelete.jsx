...
const ControlPanelContestDelete = () => {
    ...
    const handleClickOnDeleteContestButton = async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE}/contests/control/delete`, {
                method: "DELETE",
                headers: {
            ...
            // const response = await axios.delete(`${API_BASE}/contests/control/delete`, payload, {
            //     headers: {
            //         "Content-Type": "application/json",
            //         "client-id": clientId,
            //         "authorization": token,
    ...
    // Listener 2: Handle Valid Delete Contest's Details Response
    useSocketListener(
        // Selector: "Is this message for me?"
        (msg) => msg.type?.includes('response') && msg.metadata.operation?.includes("contests.control.delete"),
        ...
        async (msg) => {
            ...
            if (metadata?.success === true) {
                ...
                // Navigate to the All Contests' List Page
                navigate("/admins/control-panel/contests/all");
...
export default ControlPanelContestDelete;