...
const ControlPanelProblemDelete = () => {
    ...
    const handleClickOnDeleteProblemButton = async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE}/problems/control/delete`, {
                method: "DELETE",
                headers: { 
                    "Content-Type": "application/json", 
                    "client-id": clientId,
            ...
            // const response = await axios.delete(`${API_BASE}/problems/control/delete`, payload, {
            //     headers: {
            //         "Content-Type": "application/json",
            //         "client-id": clientId,
            //         "authorization": token,
    ...
    // Listener 2: Handle Valid Delete Problem's Response
    useSocketListener(
        // Selector: "Is this message for me?"
        (msg) => msg.type?.includes('response') && msg.metadata.operation?.includes("problems.control.delete"),
        ...
        async (msg) => {
            ...
            // If Delete Problem is Success then Save The Problems For further Accesses 
            if (metadata?.success === true) {
                console.log(data);
                console.log(metadata);
                ...
                navigate(`/admins/control-panel/problems/all`);
                    ...
                    {problemDetails ? <>
                        ...
                        <div className="text-nowrap flex flex-col gap-4">
                            ...
                            <button
                                ...
                                className="transition-all duration-[0.4s] ease-in-out hover:scale-[1.02] active:scale-[0.8] cursor-pointer py-2 lg:py-4 px-8 lg:px-16 text-lg lg:text-2xl text-white rounded-full disabled:opacity-[0.2] text-center bg-[#ff2929] poppins-semibold custom-smooth-drop-shadow">
                                Delete
                            </button>
                        </div>
...
export default ControlPanelProblemDelete;