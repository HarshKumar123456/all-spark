...
const ControlPanelProblemCreate = () => {
    ...
    const [requiredTestCasesFormat, setRequiredTestCasesFormat] = useState(
    ...
    const handleClickOnCreateProblemButton = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${API_BASE}/problems/control/create`, payload, {
                headers: {
                    "Content-Type": "application/json",
                    "client-id": clientId,
                    "authorization": token,
    ...
    // Listener 1: Handle Valid Create Problem's Response
    useSocketListener(
        // Selector: "Is this message for me?"
        (msg) => msg.type?.includes('response') && msg.metadata.operation?.includes("problems.control.create"),
        ...
        async (msg) => {
            ...
            // If Create Problem's is Success then Save The Problems For further Accesses 
...
export default ControlPanelProblemCreate;