      ...
      <Layout>
        ...
        <div className="flex flex-row items-center px-8 lg:px-16 py-16 lg:py-8">
          ...
          <div className="lg:w-1/2 mx-auto flex flex-col gap-16 lg:gap-20 lg:px-24">
            ...
            <Link to={"/login"}>
              <button className="bg-[#135BEB] cursor-pointer py-3 lg:py-4 px-18 lg:px-20 text-xl lg:text-2xl text-white rounded-full poppins-semibold custom-smooth-drop-shadow">
                Get Started
              </button>
            </Link>
